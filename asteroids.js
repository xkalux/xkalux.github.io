 ...
 */
var GameEngine = function (canvasSelector, scoreSelector, isMobile = false) {

	var isMobile = isMobile
	console.log(`isMobile: ${isMobile}`)
	if (isMobile) {
		var joyLeft = new JoyStick('joyDivLeft', {
			externalStrokeColor: '#4d5748',
			internalStrokeColor: '#77b354',
			internalFillColor: '#77b354'
		}, function (stickData) {
...
var Polygon = function (options) {
	...
	p.Draw = function (ctx) {
		...
		this.newctx.lineWidth = this.lineWidth
...
// }
var game = new GameEngine("#g-game", "#g-score", isMobile)
game.color = ""
if (typeof (Storage) !== "undefined") {
...
ship.DrawFlame = function (isShow = true) {
	if (isShow) {
		// Draw flame
		this.points = [
			{ x: 0, y: 0 },

import{d as _,u as d,a as u,c as m,b as p,r as h,o as n,e as l,f as t,t as s,g as a,F as f,h as g,n as v,i as y,j as x,k as b,l as k,m as N,_ as P}from"./index-ca9725ee.js";import{N as w}from"./NoteDisplay-e6f021f5.js";const V={class:"m-4"},D={class:"mb-10"},H={class:"text-4xl font-bold mt-2"},L={class:"opacity-50"},S={class:"text-lg"},T={class:"font-bold flex gap-2"},B={class:"opacity-50"},C=t("div",{class:"flex-auto"},null,-1),M={key:0,class:"border-gray-400/50 mb-8"},j=_({__name:"PresenterPrint",setup(z){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;

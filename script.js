...
const audio = new Audio('https://xkalux.github.io/_Antonio-Vivaldi-Summer_01.mp3')
...
const audio_on = document.getElementById('audio-on')
audio_on.style.visibility = 'hidden'
const audio_off = document.getElementById('audio-off')

const audio_toggle = () => {
    if (audio_on.style.visibility === 'hidden') {
        audio_on.style.visibility = 'visible'
        audio_off.style.visibility = 'hidden'
        audio_off.style.width = 0
        audio.play()
    } else {
        audio_off.style.visibility = 'visible'
        audio_on.style.visibility = 'hidden'
        audio.pause()
    }
}

audio_on.addEventListener('click', audio_toggle)
audio_off.addEventListener('click', audio_toggle)

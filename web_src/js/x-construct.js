const x_construct_template = document.createElement('template')
x_construct_template.innerHTML = `
<style>
...
<p>Under construction.</p>
      <a href="https://codepen.io/khadkamhn/details/NqBGOW" target="_blank">Credit: Mohan Khadka, Construction
        Machine</a>
</div>
`

window.customElements.define('x-construct', class extends HTMLElement {
    constructor() {
        super()
        let shadowRoot = this.attachShadow({ mode: 'closed' })
        shadowRoot.appendChild(x_construct_template.content.cloneNode(true))
    }
})